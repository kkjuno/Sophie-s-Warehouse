              ...
              <div className={orderDelivery_styles.web_order_delivery_period_container}>
                <div className={orderDelivery_styles.web_order_delivery_period_box_sm_container}>
                  ...
                  <div className={orderDelivery_styles.web_order_delivery_period_box_sm_wrapper}>
                    <button className={orderDelivery_styles.web_order_delivery_period_box_sm}>
                      <p className={orderDelivery_styles.web_order_delivery_period_text}>오늘</p>
                    </button>
                    <button className={orderDelivery_styles.web_order_delivery_period_box_sm}>
                      <p className={orderDelivery_styles.web_order_delivery_period_text}>7일</p>
                    </button>
                    <button className={orderDelivery_styles.web_order_delivery_period_box_sm}>
                      <p className={orderDelivery_styles.web_order_delivery_period_text}>15일</p>
                    </button>
                    <button className={orderDelivery_styles.web_order_delivery_period_box_sm}>
                      <p className={orderDelivery_styles.web_order_delivery_period_text}>1개월</p>
                    </button>
                    <button className={orderDelivery_styles.web_order_delivery_period_box_sm}>
                      <p className={orderDelivery_styles.web_order_delivery_period_text}>3개월</p>
                    </button>
                    <button className={orderDelivery_styles.web_order_delivery_period_box_sm}>
                      <p className={orderDelivery_styles.web_order_delivery_period_text}>1년</p>
                    </button>
                  </div>
                </div>
                ...
                <div className={orderDelivery_styles.web_order_delivery_period_box_lg_container}>
                  <div className={orderDelivery_styles.web_order_delivery_period_box_lg_wrapper}>
                    ...
                    <span className={orderDelivery_styles.web_order_delivery_period_text_point}>
                      ~
                    </span>
                    <div className={orderDelivery_styles.web_order_delivery_period_box_lg}>
                      <p className={orderDelivery_styles.web_order_delivery_period_text_calendar}>
