...
export default function MobileLotteryFilter({
  startDate,
  endDate,
  setStartDate,
  setEndDate,
  ...
  return (
    <div className={rewardsStyles.mobile_view_lottery_result_section}>
      <h2>당첨 내역 조회</h2>
      <hr className={rewardsStyles.mobile_lottery_main_bottom_line} />
      <div className={rewardsStyles.mobile_view_lottery_result}>
        <span>조회기간</span>
        <div className={rewardsStyles.mobile_view_lottery_day_wrapper}>
          <button
            type="button"
            onClick={() => {
        ...
        <div className={rewardsStyles.mobile_view_lottery_day_result_wrapper}>
          <div className={rewardsStyles.mobile_view_lottery_day_first}>
            <input type="text" value={startDate} onChange={(e) => setStartDate(e.target.value)} />
          </div>
          <div className={rewardsStyles.mobile_view_lottery_day_second}>
