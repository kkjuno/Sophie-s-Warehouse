    ...
    <>
      ...
      <div className={detail_styles.mobile_detail_page_wrapper}>
        <div className={detail_styles.mobile_detail_page_tit}>
          <h1 className={detail_styles.mobile_detail_page_tit_name}>이웃집 토토로 랜덥박스 메이</h1>
          <h2 className={detail_styles.mobile_detail_page_tit_price}>17,000 원</h2>
        </div>
        ...
        <section className={detail_styles.mobile_detail_product_info_wrapper}>
          ...
          <div className={detail_styles.mobile_detail_product_info_text_wrapper}>
            ...
            <p className={detail_styles.mobile_detail_product_info_text}>이웃집 토토로</p>
          </div>
          <div className={detail_styles.mobile_detail_product_info_text_wrapper}>
            <p className={detail_styles.mobile_detail_product_info_point_text}>원산지</p>
            <p className={detail_styles.mobile_detail_product_info_text}>수입산 아시아 필리핀</p>
          </div>
        ...
        <section className={detail_styles.mobile_detail_product_description_wrapper}>
          ...
          <div className={detail_styles.mobile_detail_img_wrapper}>
            <Image
              className={detail_styles.mobile_detail_img}
              src="/images/products/howl/howl-diorama.svg"
              fill
              alt="상품 이미지"
            />
          ...
          <div className={detail_styles.mobile_detail_notice_wrapper}>
            <ul className={detail_styles.mobile_detail_notice_tit}>
              ...
              <li className={detail_styles.mobile_detail_notice}>
                본 사이트 상의 모든 콘텐츠에 대한 권리는 ㈜대원미디어에 있으며, 이에 대한 무단 사용
                행위는 저작권법에 근거 5천만원 이하의 벌금 또는 5년 이하의 징역에 처해질 수
                있습니다.
              </li>
              <li className={detail_styles.mobile_detail_notice_point}>
                상품의 컬러는 고객의 모니터 환경 및 설정에 따라 실제 컬러와 다르게 보일 수 있습니다.
              </li>
              <li className={detail_styles.mobile_detail_notice}>
                지브의 상품의 경우, 수작업으로 제작되기 때문에 상품 이미지와 약간의 차이&#40;세밀한
                부분&#41;가 있을 수 있습니다. 또한 사이즈는 재는 방법에 따라 약간의 오차가 있을 수
                있습니다.
              </li>
            </ul>
          </div>
          ...
          <div className={detail_styles.mobile_detail_best_sellers_container_wrapper}>
            <div className={detail_styles.mobile_detail_best_sellers_container}>
              <div className={detail_styles.mobile_detail_best_sellers_img_wrapper}>
                <Image
                  className={detail_styles.mobile_detail_best_sellers_img}
                  src="/images/products/howl/howl-diorama.svg"
                  fill
                  alt="상품 이미지"
                />
              ...
              <p className={detail_styles.mobile_detail_best_sellers_score}>평점 4.9 / 리뷰 37</p>
            </div>
            <div className={detail_styles.mobile_detail_best_sellers_container}>
              <div className={detail_styles.mobile_detail_best_sellers_img_wrapper}>
                <Image
      ...
      <div className={detail_styles.web_detail_page_wrapper}>
        ...
        <section className={detail_styles.web_detail_top_wrapper}>
          ...
          <div className={detail_styles.web_detail_product_info_wrapper}>
            <div className={detail_styles.web_detail_product_info}>
              <h1 className={detail_styles.web_detail_product_info_tit}>라이트업 디오라마</h1>
              <p className={detail_styles.web_detail_product_info_price}>308,000원</p>
            </div>
            ...
            <div className={detail_styles.web_detail_quantity_wrapper}>
              <p className={detail_styles.web_detail_quantity_tit}>라이트업 디오라마</p>
              <div className={detail_styles.web_detail_quantity_button_wrapper}>
                ...
                <p className={detail_styles.web_detail_shipping_policy_price}>17,000 원</p>
              </div>
            </div>
        ...
        <nav className={detail_styles.web_detail_nav}>
          <Link className={detail_styles.web_nav_item} href="#">
            상세정보
          </Link>
          <Link className={detail_styles.web_nav_item} href="#">
            리뷰
        ...
        <section className={detail_styles.web_detail_container}>
          ...
          <div className={detail_styles.web_detail_info_wrapper}>
            ...
            <div className={detail_styles.web_detail_info}>
              ...
              <p className={detail_styles.web_detail_info_text}>이웃집 토토로</p>
            ...
            <div className={detail_styles.web_detail_info_notice_wrapper}>
              ...
              <ul className={detail_styles.web_detail_info_notice_list_wrapper}>
                <li className={detail_styles.web_detail_info_notice_list}>
                  본 사이트에 등록된 대표이미지와 다를 수 있습니다. 이에 대한 반품 사유는 반영되지
                  않으며 오배송이 아닌 단순 변심 또는 외관상 차이에 따른 반품은 불가할 수 있습니다.
                </li>
                <li className={detail_styles.web_detail_info_notice_list}>
          ...
          <section className={detail_styles.web_detail_best_sellers_wrapper}>
            ...
            <div className={detail_styles.web_detail_best_sellers_container_wrapper}>
              <div className={detail_styles.web_detail_best_sellers_container}>
                ...
                <p className={detail_styles.web_detail_best_sellers_score}>평점 4.9 / 리뷰 37</p>
              </div>
              <div className={detail_styles.web_detail_best_sellers_container}>
                <div className={detail_styles.web_detail_best_sellers_img_wrapper}>
                  <Image
