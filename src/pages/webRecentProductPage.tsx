...
import styles from './webRecentProductPage.module.css';
...
const webRecentProductsPage: React.FC = () => {
            ...
            {recentProducts.length === 0 ? (
              ...
              <div className={styles.product_list}>
                {recentProducts.map((product, index) => (
                  <div
                    key={product.id}
                    className={`${styles.product_item} ${index < recentProducts.length - 1 ? styles.product_item_border : ''}`}
                  >
                    {/* 상품 이미지 */}
                    <div
...
export default webRecentProductsPage;
