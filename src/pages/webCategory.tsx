...
import styles from './webCategory.module.css';
        ...
        <div className={styles.product_area}>
          ...
          <div className={styles.product_grid}>
            {sampleProducts.map((product, index) => (
              <div key={index} className={styles.simple_product_card}>
                <div className={styles.simple_product_image}>
                  <img src={product.image} alt={product.name} />
                </div>
                <h4 className={styles.simple_product_name}>{product.name}</h4>
                <p className={styles.simple_product_price}>{product.price.toLocaleString()}원</p>
                <p className={styles.simple_product_actions}>
                  평점 {product.likes} /리뷰{product.comments}
                </p>
              </div>
            ))}
